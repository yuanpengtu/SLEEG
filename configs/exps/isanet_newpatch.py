...
model = dict(
    ...
    pretrained='./isanet_r101-d8_769x769_80k_cityscapes_20210903_111319-24f71dfa.pth',
    backbone=dict(
        type='ResNetV1c',
        depth=101,
        num_stages=4,
    ...
    #test_cfg=dict(mode='slide', crop_size=(769, 769), with_ood=False, merge_weight=0.5, stride=(513, 513)))
...
work_dir = './results/day927/isanet101_nofix10_003006_weight005_weight_769_newhead/'

load_from = './isanet_r101-d8_769x769_80k_cityscapes_20210903_111319-24f71dfa.pth'
