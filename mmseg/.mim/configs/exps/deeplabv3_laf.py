...
model = dict(
    ...
    pretrained='./backbones/resnet101-63fe2227.pth',
    backbone=dict(
        type='ResNetV1c',
        depth=101,
        num_stages=4,
    ...
    test_cfg=dict(mode='whole', with_ood=False, merge_weight=0.0))
...
work_dir = './results/day927/deeplabv350_fix10_copypaste003006_lostandfound/'

load_from = './results/deeplabv3/iter_40000.pth'
