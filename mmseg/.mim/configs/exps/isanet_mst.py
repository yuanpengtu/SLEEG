...
model = dict(
    ...
    pretrained='./isanet_r101-d8_512x1024_40k_cityscapes_20210901_145553-293e6bd6.pth',
    backbone=dict(
        type='ResNetV1c',
        depth=101,
        num_stages=4,
...
work_dir = './results/day927/isanet101_nofix10_003006_weight005_weight_769/'

load_from = './isanet_r101-d8_512x1024_40k_cityscapes_20210901_145553-293e6bd6.pth'
