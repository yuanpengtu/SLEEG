...
model = dict(
    ...
    pretrained='./mmsegmentation/work_dirs/segformer_mit-b5_8x1_1024x1024_160k_cityscapes/latest.pth',#'./segformer_mit-b4_8x1_1024x1024_160k_cityscapes_20211207_080709-07f6c333.pth',
    backbone=dict(
...
work_dir = './results/day928/segformerb4_nofix10_003006_weight005_adv_weight6k/'
