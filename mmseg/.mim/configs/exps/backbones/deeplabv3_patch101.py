...
model = dict(
    ...
    pretrained='./resnet101-63fe2227.pth',
    backbone=dict(
        type='ResNetV1c',
        depth=101,
        num_stages=4,
...
work_dir = './results/day927/deeplabv3101_fix10_copypaste003006_gradientnew/'

load_from = './deeplabv3plus_r101-d8_512x1024_40k_cityscapes_20200605_094614-3769eecf.pth'
