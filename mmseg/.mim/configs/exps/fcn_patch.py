...
model = dict(
    ...
    pretrained='./fcn_d6_r101b-d16_512x1024_80k_cityscapes_20210311_144305-3f2eb5b4.pth',
    backbone=dict(
        type='ResNet',
        depth=101,
        num_stages=4,
...
work_dir = './results/day927/fcn_nofix10_003006_weight005_weightnew/'

load_from = './fcn_d6_r101b-d16_512x1024_80k_cityscapes_20210311_144305-3f2eb5b4.pth'
